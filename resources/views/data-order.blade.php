...
@endif
                        ...
                        <form action="{{url('/search/'.$users->id.'/update')}}" method="post">
                            @csrf
                            <input type="hidden" autocomplete="false">
                                <div class="form-group">
                                    ...
                                    @endif
                                    <input type="text" name="bnccId" placeholder="BNCC ID" class="form-input" onfocus="this.placeholder = ''" onblur="this.placeholder = 'BNCC ID'"  onkeydown="validateIsNIM(event)" autofocus required>
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <input id="input-name" value="{{$users->nama}}" type="text" name="nama" placeholder="Name" class="form-input" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Name'"  onkeydown="validateIsName(event)" required>
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <input type="text" value="{{$users->nim}}" name="nim" placeholder="NIM" class="form-input" onfocus="this.placeholder = ''" onblur="this.placeholder = 'NIM'"  onkeydown="validateIsNIM(event)" required>
                            ...
                            <div class="form-group">
                                    ...
                                    @endif
                                    <input type="text" name="jurusan" value="{{$users->jurusan}}"placeholder="Jurusan" class="form-input" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Jurusan'" required>
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <input type="text" name="tlp" placeholder="Phone" value="{{$users->tlp}}"class="form-input" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone'"  onkeydown="validateIsPhone(event)" required>
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <input type="text" name="lineId" placeholder="Line ID" value="{{$users->lineId}}" class="form-input" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Line ID'" required>
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <input type="text" name="email" value="{{$users->email}}" placeholder="Email" class="form-input" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email'" onkeyup="validateIsEmail(event)" required>
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <input type="text" name="pembayar" placeholder="Atas Nama " class="form-input" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Atas Nama'"  required>
                                <label class="animated fadeIn" for="pembayar">Atas Nama </label>
                            </div>
                            <div class="form-group">
                                    <select class="form-input" name="schedule_id" id="">
				    <option class="form-input" value="">--Pilih Jadwal--</option>
                                    @foreach($schedules as $schedule)
                                        @if($schedule->increments <= 50)
                                            <option class="form-input" value="{{$schedule->id}}">{{ \Carbon\Carbon::parse($schedule->jadwal)->format('d M Y, h:i:s a') }}</option>
                                        @endif
                                    @endforeach
                                    </select>
