            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6 px-5">
                        <h2 class="card-title text-center">Lucky Draw !</h2>
                        @if(session()->has('message'))
    <div class="alert alert-success">
        {{ session()->get('message') }}
    </div>
@endif
                        <form class="my-4" action="{{url('/luckydraw/post')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                    ...
                    <div class="col-lg-6 d-flex align-items-center">
                        <div class="left-register-container container px-5">
                            <img id="bncc-logo" class="img-fluid mx-auto bncc-logo" src="{{asset('assets/BNCC-black-compressed.png')}}" alt="">
                            <div class="py-3"><img class="img-fluid mx-auto gojek-logo mt-2" src="{{asset('assets/gojek.png')}}" alt=""><h4 class="text-center">Official Learning Partner </h4></div>
                            <img class="img-fluid px-2 py-4 artwork-img animated fadeInUp" src="{{asset('assets/regis-artwork-compressed.png')}}" alt="">
                            <h4 class="text-center">See You at Registration</h4>
                        </div>
                    </div>
                </div>
            </div>
