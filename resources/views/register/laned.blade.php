...
@endif
                        ...
                        <form class="my-4" action="{{url('/register/d/post')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <input type="hidden" autocomplete="false">
                                <div class="form-group">
                                    ...
                                    @endif
                                    <input type="text" name="bnccId" placeholder="BNCC ID" class="form-input" onfocus="this.placeholder = ''" onblur="this.placeholder = 'BNCC ID'" value="{{ old('bnccId') }}" onkeydown="validateIsNIM(event)" autofocus required>
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <input type="text" name="tlp" placeholder="Phone" class="form-input" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone'" value="{{ old('tlp') }}" onkeydown="validateIsPhone(event)" required>
