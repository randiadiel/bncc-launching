            ...
            <div class="card-body my-4">
                <div class="row">
                    <div class="col-lg-6 px-5">
                        ...
                        <form class="my-4" action="{{url('/register/c/post')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <input id="input-name" type="text" name="nama" placeholder="Name" class="form-input" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Name'" value="{{ old('nama') }}" onkeydown="validateIsName(event)" autofocus required>
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <input type="text" name="nim" placeholder="NIM" class="form-input" onfocus="this.placeholder = ''" onblur="this.placeholder = 'NIM'"  onkeydown="validateIsNIM(event)" value="{{ old('nim') }}" required>
